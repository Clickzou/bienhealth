    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="grid lg:grid-cols-2 items-center">
        ...
        <div className="relative h-56 sm:h-72 lg:h-[400px] order-1 lg:order-none">
          <Image src="/brand/presse-sud-radio.jpeg" alt="BIEN health sur Sud Radio" fill fetchPriority="high" loading="eager" sizes="(max-width:1024px) 100vw, 50vw" className="object-cover" />
        </div>
