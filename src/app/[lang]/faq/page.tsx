...
const SECTIONS_FR: Section[] = [
  {
    ...
    items: [
      ...
      { q: "Quels sont les ingrédients de MushGlow ?", a: "Lion's Mane 750 mg (fonction cognitive), Cordyceps 500 mg (énergie, endurance), Chaga 500 mg (antioxydants), L-Théanine 500 mg (concentration), Maca 750 mg (hormones, humeur) et Collagène 300 mg (hydratation de la peau)." },
...
const SECTIONS_EN: Section[] = [
  {
    ...
    items: [
      ...
      { q: "What are the ingredients in MushGlow?", a: "Lion's Mane 750 mg (cognitive function), Cordyceps 500 mg (energy, stamina), Chaga 500 mg (antioxidants), L-Theanine 500 mg (focus), Maca 750 mg (hormones, mood) and Collagen 300 mg (skin hydration)." },
