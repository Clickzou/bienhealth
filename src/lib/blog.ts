...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    metaDescription:
      "Comment gérer le stress naturellement ? Respiration, sommeil, plantes adaptogènes (ashwagandha, reishi)… 7 solutions concrètes et naturelles pour retrouver la sérénité.",
    excerpt:
    ...
    blocks: [
      ...
      { p: "Stress et sommeil s'entretiennent mutuellement. Des horaires réguliers, une chambre au frais, moins d'écrans le soir : ces habitudes améliorent la qualité des nuits. Pour aller plus loin, découvrez comment <a href=\"" + l("/blog/mieux-dormir-naturellement") + "\">mieux dormir naturellement</a>." },
      { h2: "4. Soigner son alimentation" },
      { p: "Café en excès, sucre et alcool amplifient l'anxiété. À l'inverse, une alimentation riche en magnésium, en oméga-3 et en fibres soutient l'équilibre nerveux. Limitez les excitants, surtout en fin de journée." },
      { h2: "5. S'appuyer sur les plantes adaptogènes" },
      { p: "Les <a href=\"" + l("/blog/champignons-adaptogenes-guide-complet") + "\">adaptogènes</a> aident l'organisme à mieux réguler sa réponse au stress. L'<strong>ashwagandha</strong> est étudiée pour son action sur le cortisol, le <strong>reishi</strong> favorise la détente, et le <strong>safran</strong> soutient l'humeur. Nos gummies <a href=\"" + l("/products/calm") + "\">CALM</a> réunissent ces trois actifs dans une formule pensée pour la sérénité et le sommeil." },
    ...
    faq: [
      { q: "Quelle plante pour gérer le stress ?", a: "L'ashwagandha est l'une des plus étudiées pour son action sur le cortisol. Le reishi et le safran la complètent bien : ces trois actifs sont réunis dans les gummies CALM de BIEN." },
      { q: "Combien de temps pour ressentir les effets ?", a: "Les techniques comme la respiration agissent immédiatement. Les adaptogènes, eux, demandent de la régularité : comptez une cure d'au moins 30 jours pour des effets durables." },
      { q: "Le stress peut-il empêcher de dormir ?", a: "Oui, le stress est l'une des premières causes des troubles de l'endormissement. Agir sur le stress améliore souvent directement la qualité du sommeil." },
    ],
    en: {
      ...
      blocks: [
        ...
        { p: "Stress and sleep feed off each other. Regular hours, a cool bedroom, fewer screens in the evening: these habits improve the quality of your nights. To go further, discover how to <a href=\"" + le("/blog/mieux-dormir-naturellement") + "\">sleep better naturally</a>." },
        { h2: "4. Take care of your diet" },
        { p: "Too much coffee, sugar and alcohol amplify anxiety. Conversely, a diet rich in magnesium, omega-3 and fibre supports nervous balance. Limit stimulants, especially late in the day." },
        { h2: "5. Rely on adaptogenic plants" },
        { p: "<a href=\"" + le("/blog/champignons-adaptogenes-guide-complet") + "\">Adaptogens</a> help the body better regulate its stress response. <strong>Ashwagandha</strong> is studied for its action on cortisol, <strong>reishi</strong> promotes relaxation, and <strong>saffron</strong> supports mood. Our <a href=\"" + le("/products/calm") + "\">CALM</a> gummies bring these three actives together in a formula designed for calm and sleep." },
      ...
      faq: [
        { q: "Which plant to manage stress?", a: "Ashwagandha is one of the most studied for its action on cortisol. Reishi and saffron complement it well: these three actives are combined in BIEN's CALM gummies." },
        { q: "How long before you feel the effects?", a: "Techniques like breathing act immediately. Adaptogens, on the other hand, require regularity: allow a course of at least 30 days for lasting effects." },
        { q: "Can stress stop you sleeping?", a: "Yes, stress is one of the leading causes of difficulty falling asleep. Acting on stress often directly improves sleep quality." },
      ],
    },
  },
  {
